...
/**
 * This class defines the exception ErrorUpdateTimeFailed that is thrown if the
 * execution of the Secure Element functionality for setting the time failed
 *
 */

public final class ErrorUpdateTimeFailed extends java.lang.Exception {

    /**
     * Constructs a new ErrorUpdateTimeFailed exception with null as the value for
     * its detail message
     */
    ...
    /**
     * Constructs a new ErrorUpdateTimeFailed exception whereby its detail message
     * is initialized with the passed value
     * 
     * @param message
     *            value for the detail message of the exception
     */
    public ErrorUpdateTimeFailed(String message) {
        super(message);
    }
     ...
     */
    public ErrorUpdateTimeFailed(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     *            this exception
     */
    public ErrorUpdateTimeFailed(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
